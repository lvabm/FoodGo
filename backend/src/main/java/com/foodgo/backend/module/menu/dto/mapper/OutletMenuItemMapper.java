...
import com.foodgo.backend.module.menu.dto.request.OutletMenuItemUpdateRequest;
...
public class OutletMenuItemMapper {
  public OutletMenuItem toEntity(
      OutletMenuItemCreateRequest dto, MenuItem menuItem, Outlet outlet) {
