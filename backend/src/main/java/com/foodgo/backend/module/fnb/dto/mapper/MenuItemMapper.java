...
import com.foodgo.backend.module.fnb.dto.request.MenuItemCreateRequest;
import com.foodgo.backend.module.fnb.dto.request.MenuItemUpdateRequest;
import com.foodgo.backend.module.fnb.dto.response.MenuItemResponse;
...
public class MenuItemMapper {
    ...
    public MenuItem toEntity(MenuItemCreateRequest dto, MenuItemSubCategory subCategory, Province province) {
        if (dto == null)
            return null;
    ...
    public void updateEntityFromDTO(MenuItem entity, MenuItemUpdateRequest dto, MenuItemSubCategory subCategory,
            Province province) {
        if (dto == null)
            return;
        entity.setName(dto.getName());
