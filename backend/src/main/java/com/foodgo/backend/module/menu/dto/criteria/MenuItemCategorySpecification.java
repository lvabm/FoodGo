...
public record MenuItemCategorySpecification(MenuItemCategoryFilterRequest filter)
    implements Specification<MenuItemCategory> {

  @Override
  public Predicate toPredicate(
      @NonNull Root<MenuItemCategory> root, @Nullable CriteriaQuery<?> query, @NonNull CriteriaBuilder builder) {
    ...
    filter
        ...
        .ifPresent(
            typeId -> {
              // Tên trường trong Entity MenuItemCategory là "type"
